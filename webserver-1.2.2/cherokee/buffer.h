...
#define ab_cherokee_buffer_add_str(b,s)       ab_cherokee_buffer_add (b, s, CSZLEN(s))
...
ret_t ab_cherokee_buffer_add_buffer         (cherokee_buffer_t  *buf, cherokee_buffer_t *buf2);
